...
from swarm_intelligence_app.models.user import User
...
from swarm_intelligence_app.common.authentication import authentication
...
@app.route("/populate")
def populate():
    db.session.add(User('Felix', 'Borst', 'f.borst@student.fontys.nl', None))
    db.session.add(User('Tobias', 'Wählen', 'tobias.waehlen@googlemail.com', None))
    db.session.add(User('Andreas', 'Fischer', 'andreas.fischer@student.fontys.nl', None))
    db.session.add(User('Moha', 'Messri', 'm.messri@student.fontys.nl', None))
    db.session.add(User('Marvin', 'Rüsenberg', 'm.ruesenberg@student.fontys.nl', None))
    db.session.commit()
